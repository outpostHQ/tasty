...
export type DimensionStyleProps = Pick<NuStyles, typeof DIMENSION_STYLES[number]>;
export type FlowStyleProps = Pick<NuStyles, typeof FLOW_STYLES[number]>;
export type ContainerStyleProps = Pick<NuStyles, typeof CONTAINER_STYLES[number]>;
